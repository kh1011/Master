...
import com.yxclient.app.adapter.CategorizeShopAdapter;
...
public class CategorizeFragment extends Fragment {
    ...
    private CategorizeShopAdapter categorizeProductAdapter;
    ...
    private void initViewPager() {
        ...
        categorizeProductAdapter = new CategorizeShopAdapter(getChildFragmentManager(), listMenus);
    ...
    private void initTools(View layoutView) {
        ...
        for (int i = 0; i < listMenus.length; i++) {
            View view = mlinflater.inflate(R.layout.itemview_categorize_listmenus, null);
            // 给每个View设定唯一标识
            view.setId(i);
            // 给每个view添加点击监控事件
