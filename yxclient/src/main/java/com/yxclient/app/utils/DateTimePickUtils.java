...
public class DateTimePickUtils implements OnValueChangeListener,
	...
	public DateTimePickUtils(Context activity, String initDateTime,
	...
	public void onDateChanged() {
		...
		if (calendar.getTimeInMillis() <= System.currentTimeMillis() + 2 * 3600000
				|| calendar.getTimeInMillis() > System.currentTimeMillis() + 7
						* 24 * 3600 * 1000) {
			tv_time.setText("请预约两小时以后的有效时间");
		...
		case R.id.tv_confirm:
			if (calendar.getTimeInMillis() <= System.currentTimeMillis() + 2 * 3600000
					|| calendar.getTimeInMillis() > System.currentTimeMillis()
							+ 7 * 24 * 3600 * 1000) {
				Toast.makeText(activity, "请预约两小时以后的有效时间", Toast.LENGTH_SHORT)
						.show();
