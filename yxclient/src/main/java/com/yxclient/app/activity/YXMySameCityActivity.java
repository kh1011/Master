...
import com.yxclient.app.adapter.SameCityAdapter;
 ...
 */
public class YXMySameCityActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, RecyclerArrayAdapter.OnLoadMoreListener {
    ...
    public static Intent createIntent(Context context) {
        return new Intent(context, YXMySameCityActivity.class);
    }
    ...
    private void getData(String token, final int curentPage, int size) {
        ...
        RetrofitHttp.getRetrofit(builder.build()).getMySameCityList(token, curentPage, size).enqueue(new Callback<ResponseBody>() {
            @Override
