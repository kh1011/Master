...
import com.yxclient.app.view.BaseDialog;

import java.io.File;

import zuo.biao.library.versionchecklib.callback.APKDownloadListener;
import zuo.biao.library.versionchecklib.callback.CommitClickListener;
import zuo.biao.library.versionchecklib.callback.DialogDismissListener;
import zuo.biao.library.versionchecklib.core.VersionDialogActivity;
...
//        Log.e("CustomVersionDialogActi", "正在下载中回调...");
    ...
    public void showLoadingDialog(int currentProgress) {
        if (!isCustomDownloading) {
            ...
            ProgressBar pb = (ProgressBar) loadingView.findViewById(zuo.biao.library.R.id.pb);
            TextView tvProgress = (TextView) loadingView.findViewById(zuo.biao.library.R.id.tv_progress);
            tvProgress.setText(String.format(getString(zuo.biao.library.R.string.versionchecklib_progress), currentProgress));
