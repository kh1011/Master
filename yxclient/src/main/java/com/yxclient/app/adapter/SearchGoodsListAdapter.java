...
import com.yxclient.app.viewholder.SearchGoodsListViewHoder;
...
public class SearchGoodsListAdapter extends RecyclerArrayAdapter<GoodPruductModel> {
    Context context;
    ...
    public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
        return new SearchGoodsListViewHoder(parent, context);
    }
