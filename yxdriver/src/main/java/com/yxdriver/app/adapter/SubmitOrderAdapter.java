...
import com.yxdriver.app.model.bean.SubmitOrderModel;
import com.yxdriver.app.view.SubmitOrderView;
...
public class SubmitOrderAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tvPrice.setText(String.format("¥ %s", model.getPrice() / 100.0));
        viewHolder.btnResult.setText(String.valueOf(buyAllNum));
        double itemResult = model.getPrice() * buyAllNum;
        viewHolder.tvItemPrice.setText(String.format("￥%s", itemResult));
...
//        orderModel.setProduct(String.valueOf(itemResult));
    ...
    private void appenedBuyNum(GoodPruductModel model) {
        ...
        viewHolder.btnResult.setText(String.valueOf(buyAllNum));
        double itemResult = model.getPrice() * buyAllNum;
        viewHolder.tvItemPrice.setText(String.format("￥%s", itemResult / 100.0));
