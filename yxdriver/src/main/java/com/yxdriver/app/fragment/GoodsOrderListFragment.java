...
import com.yxdriver.app.activity.YXTripDetailActivity;
import com.yxdriver.app.adapter.TripOrderAdapter;
 ...
 * 货运订单
 */
public class GoodsOrderListFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, RecyclerArrayAdapter.OnLoadMoreListener {
    ...
    public void initView() {
        ...
        adapter.setOnItemClickListener(new RecyclerArrayAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                // 到详情页面
                Log.e("position的值为:", String.valueOf(position));
                if (position==-1){
                    return;
                }else {
    ...
    public void onRefresh() {
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                page = 1;
                adapter.clear();
                getOrderData(DemoApplication.getInstance().getMyToken(), "", YXConfig.EXPRESS, page, pageSize);
            }
        }, 2000);
    }
                            ...
                            switch (response.code()) {
                                case 200:
                                    if (response.body() == null) {
                                        ...
                                        System.out.println("货运订单列表数据" + result);
