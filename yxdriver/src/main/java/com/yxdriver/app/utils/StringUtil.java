...
public class StringUtil {
    ...
    public static RequestBody getBody(JSONObject object) {
        ...
        System.out.println("body参数：" + test);
    ...
    */
    ...
    public static newOrderModel changeObject(OrderModel orderModel){
        ...
        if (orderModel!=null){
            ...
            com.yxdriver.app.model.bean.newOrderModel.OriginBean originBean=new newOrderModel.OriginBean();
            ...
            com.yxdriver.app.model.bean.newOrderModel.SiteBean siteBean=new newOrderModel.SiteBean();
            ...
            com.yxdriver.app.model.bean.newOrderModel.UserBean userBean=new newOrderModel.UserBean();
