...
import com.yxdriver.app.MainActivity;
...
public class ApplicationActiivty extends AppCompatActivity {
    ...
    private void setAnimListener() {
        ...
        mFadeOut.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                ...
                intent.setClass(ApplicationActiivty.this, YXLoginActivity.class);
                //测试 add by zhangyun  2017年9月20日 20:24:28 start
                //测试上传照片信息界面
                //intent.setClass(ApplicationActiivty.this, YXSetInfoPhotoActivity.class);
                //测试 add by zhangyun  2017年9月20日 20:24:28 end
    ...
    private void RandomApplicationBg() {
        ...
        if (index == 1) {
            applicationBg.setImageResource(R.drawable.welcome);
        } else {
            applicationBg.setImageResource(R.drawable.welcome);
        }
    }
