...
public class YXOrderMapActivity extends BaseActivity implements AMap.OnMapClickListener,
    ...
    public void onForwardClick(View v) {
        ...
        AmapNaviPage.getInstance().showRouteActivity(getApplicationContext(), new AmapNaviParams(new Poi(model.getOrigin().getAddress(), origin, ""), null, new Poi(model.getSite().getAddress(), site, ""), AmapNaviType.DRIVER), YXOrderMapActivity.this);
    }
