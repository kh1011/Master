 ...
 */
// 测试行走里程
public class YXTestDistanceActivity extends BaseActivity implements LocationSource,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yx_test_distance);
    ...
    public static Intent createIntent(Context context, String data) {
        return new Intent(context, YXTestDistanceActivity.class).
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (btn.isChecked()) {
                    ...
                    mTraceClient.queryProcessedTrace(2, Util.parseTraceLocationList(record.getPathline()), LBSTraceClient.TYPE_AMAP, YXTestDistanceActivity.this);
    ...
    protected void saveRecord(List<AMapLocation> list, String time) {
        if (list != null && list.size() > 0) {
            ...
            Toast.makeText(context, "没有记录到路径", Toast.LENGTH_SHORT)
                    .show();
        }
    }
        ...
        if (lineID == 1) {
            if (linepoints != null && linepoints.size() > 0) {
                ...
                if (mlocMarker == null) {
                    ...
                    Toast.makeText(YXTestDistanceActivity.this, "距离" + mDistance, Toast.LENGTH_SHORT).show();
