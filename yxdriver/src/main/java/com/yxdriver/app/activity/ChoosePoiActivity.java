...
import com.yxdriver.app.poisearch.searchmodule.ISearchModule.IDelegate.IParentDelegate;
import com.yxdriver.app.poisearch.searchmodule.SearchModuleDelegate;
import com.yxdriver.app.poisearch.util.CityModel;
import com.yxdriver.app.poisearch.util.FavAddressUtil;
import com.yxdriver.app.poisearch.util.PoiItemDBHelper;

import zuo.biao.library.base.BaseActivity;

import static com.yxdriver.app.poisearch.searchmodule.ISearchModule.IDelegate.START_POI_TYPE;
...
public class ChoosePoiActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_poi_content);
        initView();
        initData();
        initEvent();
