...
import com.yxdriver.app.view.SafeView;
 ...
 * 抢单中
 */
public class YXDoingActivity extends BaseActivity {
    @BindView(R.id.cl_loding)
    SafeView custLoding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yx_doing);
    ...
    public static Intent createIntent(Context context, String data) {
        return new Intent(context, YXDoingActivity.class).
