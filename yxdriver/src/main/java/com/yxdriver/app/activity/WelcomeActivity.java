...
import com.yxdriver.app.adapter.ViewPagerAdapter;
   ...
   /* @BindView(R.id.goLogin)
    ...
    private void initData() {
       ...
       /* if (!JUtils.isNetWorkAvilable()) {
            ...
            for (int i = 0; i < YXConfig.pricUrls.length; i++) {
                length = YXConfig.pricUrls.length;
                SimpleDraweeView iv = new SimpleDraweeView(this);
                iv.setLayoutParams(mParams);
                //防止图片不能填满屏幕
                iv.setScaleType(ImageView.ScaleType.FIT_XY);
            ...
            if (position == length - 1) {
                ...
                goComing.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.setClass(WelcomeActivity.this, YXLoginActivity.class);
                ...
                /*goLogin.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.setClass(WelcomeActivity.this, TestPhotoMainActivity.class);
