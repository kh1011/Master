...
import zuo.biao.library.pays.sdk.CommonAlipayResult;
import zuo.biao.library.pays.sdk.CommonPayConfig;
import zuo.biao.library.pays.sdk.ICanPayOrderInfo;

import static zuo.biao.library.pays.sdk.CommonPayConfig.REQ_PAY_RESULT_CODE_ERROR;
...
//                uiHintAgent.loadDialogDismiss();
    ...
    protected void paySuc(String successHintInfo) {
        //DialogUIUtils.showToast(successHintInfo);
        finishSelf(true);
    ...
    protected void payFailure(String failureHintMsg) {
        //DialogUIUtils.showToast(failureHintMsg);
