...
import zuo.biao.library.versionchecklib.core.http.HttpHeaders;
import zuo.biao.library.versionchecklib.core.http.HttpParams;
import zuo.biao.library.versionchecklib.core.http.HttpRequestMethod;
import zuo.biao.library.versionchecklib.utils.FileHelper;
...
public class VersionParams implements Parcelable {
    ...
    private zuo.biao.library.versionchecklib.core.http.HttpHeaders httpHeaders;
