...
public interface Presenter {
	...
	static final String RESULT_DATA2 = "RESULT_DATA2";
	static final String ACTION_EXIT_APP = "ACTION_EXIT_APP";
	static final String RESULT_CODE = "RESULT_CODE";

	static final String RESULT_ORIGIN = "RESULT_ORIGIN";
	static final String RESULT_SITE = "RESULT_SITE";
	static final String RESULT_INFOTYPE = "RESULT_INFOTYPE";
